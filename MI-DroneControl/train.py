...
if __name__ == "__main__" and any(arg in {"-h", "--help"} for arg in sys.argv[1:]):
    ...
    print()
    print("Collect MindWave training data and write shared model artifacts into models/.")
    raise SystemExit(0)

REPO_ROOT = Path(__file__).resolve().parent.parent
DRONE_DIR = REPO_ROOT / "MI-DroneControl"
...
BASE_DIR = REPO_ROOT / "MI-DroneControl"
