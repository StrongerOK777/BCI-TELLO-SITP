...
if __name__ == "__main__" and any(arg in {"-h", "--help"} for arg in sys.argv[1:]):
    print("usage: train_user.py")
    print()
    print("Collect MindWave training data and write shared artifacts into src/.")
    raise SystemExit(0)
...
PICTURE_DIR = SRC_DIR / "picture"
for directory in (DATA_DIR, MODEL_DIR, PICTURE_DIR):
...
def writedata():
    ...
    neuropy = NeuroSkyPy(interface.port, interface.baud)
    # 打开串口连接
    neuropy.start()
    try:
        files = {
